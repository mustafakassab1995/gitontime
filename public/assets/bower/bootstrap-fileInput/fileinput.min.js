...
! function (e) {
    ...
    i = {
        ...
        handler: function (e, t, a, r) {
            var n = r ? t : t.split(" ").join(i.NAMESPACE + " ") + i.NAMESPACE;
            e.length && e.off(n).on(n, a)
        },
        isIE: function (e) {
        ...
        _init: function (t) {
            var a, r = this,
                n = r.$element;
            r.options = t, e.each(t, function (e, t) {
                switch (e) {
                case "minFileCount":
                case "maxFileCount":
                case "maxFileSize":
        ...
        _addError: function (e) {
            var t = this,
                a = t.$errorContainer;
            e && a.length && (a.html(t.errorCloseButton + e), i.handler(a.find(".kv-error-close"), "click", function () {
                a.fadeOut("slow")
            }))
        },
        ...
        _initClickable: function () {
            var t, a = this;
            a.isClickable && (t = a.isUploadable ? a.$dropZone : a.$preview.find(".file-default-preview"), i.addCss(t, "clickable"), t.attr("tabindex", -1), i.handler(t, "click", function (i) {
                var r = e(i.target);
        ...
        _initDragDrop: function () {
            var t = this,
                a = t.$dropZone;
            t.isUploadable && t.dropZoneEnabled && t.showPreview && (i.handler(a, "dragenter dragover", e.proxy(t._zoneDragEnter, t)), i.handler(a, "dragleave", e.proxy(t._zoneDragLeave, t)), i.handler(a, "drop", e.proxy(t._zoneDrop, t)), i.handler(e(document), "dragenter dragover drop", t._zoneDragDropInit))
        },
        ...
        _zoneDragEnter: function (t) {
            var a = this,
                r = e.inArray("Files", t.originalEvent.dataTransfer.types) > -1;
        ...
        _setZoomContent: function (t, a) {
            var r, n, o, l, s, d, c, p, u, f, m = this,
                ...
                E = m.$preview.find("#zoom-" + g);
            n = E.attr("data-template") || "generic", r = E.find(".kv-file-content"), o = r.length ? r.html() : "", u = t.data("caption") || "", f = t.data("size") || "", l = u + " " + f, v.find(".kv-zoom-title").html(l), s = v.find(".kv-zoom-body"), v.removeClass("kv-single-content"), a ? (p = s.clone().insertAfter(s), s.html(o).hide(), p.fadeOut("fast", function () {
        ...
        _zoomPreview: function (t) {
            var a, r = this,
                n = e("body"),
                o = r.$modal;
            if (!t.length) throw "Cannot zoom to detailed preview!";
            n.length && o.appendTo(n), o.html(r._getModalContent()), a = t.closest(i.FRAMES), r._setZoomContent(a), o.modal("show"), r._initZoomButtons()
        },
        ...
        _initPreviewActions: function () {
            ...
            t._initZoomButton(), a.find(n).each(function () {
                ...
                if (!i.isEmpty(l) && void 0 !== s) {
                    var d, c, p, u, f = n.closest(i.FRAMES),
                    ...
                    g = parseInt(g.replace("init_", "")), p = i.isEmpty(m.config) && i.isEmpty(m.config[g]) ? null : m.config[g], u = i.isEmpty(p) || i.isEmpty(p.extra) ? r : p.extra, "function" == typeof u && (u = u()), c = {
                        ...
                        success: function (e, r, l) {
                            var d, p;
                            return i.isEmpty(e) || i.isEmpty(e.error) ? (t.previewCache.init(), g = parseInt(f.data("fileindex").replace("init_", "")), t.previewCache.unset(g), d = t.previewCache.count(), p = d > 0 ? t._getMsgSelected(d) : "", t._raise("filedeleted", [s, l, u]), t._setCaption(p), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function () {
        ...
        _resetUpload: function () {
            ...
            e.uploadCache = {
                ...
                tags: [],
                append: !0
            }, e.uploadCount = 0, e.uploadStatus = {}, e.uploadLog = [], e.uploadAsyncCount = 0, e.loadedImages = [], e.totalImagesCount = 0, e.$btnUpload.removeAttr("disabled"), e._setProgress(0), i.addCss(e.$progress, "hide"), e._resetErrors(!1), e.ajaxAborted = !1, e.ajaxRequests = [], e._resetCanvas(), e.cacheInitialPreview = {}
        },
        ...
        _initSuccessThumbs: function () {
            ...
            t.showPreview && t._getThumbs(i.FRAMES + " .file-preview-success").each(function () {
                ...
                n.removeAttr("disabled"), i.handler(n, "click", function () {
                    var e = a.attr("id"),
                        n = t._raise("filesuccessremove", [e, a.data("fileindex")]);
        ...
        _uploadSingle: function (t, a, r) {
            ...
            g.formdata = h, g.showPreview && (o = e("#" + w + ":not(.file-preview-initial)"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), b.removeClass("hide")), 0 === v || !_ || s && s.hasClass("disabled") || g._abort(C) || (m = function (e, i) {
                ...
                var e, t, a, r, n = g.uploadCache,
                    o = g.cacheInitialPreview;
                g.fileBatchCompleted && setTimeout(function () {
                    if (g.showPreview) {
                        ...
                        } else g.initialPreview = n.content, g.initialPreviewConfig = n.config, g.initialPreviewThumbTags = n.tags;
                ...
                var s = g.ajaxOperations.uploadThumb,
                    d = g._parseError(s, i, l, r ? a[t].name : null);
                setTimeout(function () {
        ...
        _getSize: function (i) {
            var t, a, r, n = this,
                o = parseFloat(i),
                l = n.fileSizeGetter;
            return e.isNumeric(i) && e.isNumeric(o) ? ("function" == typeof l ? r = l(o) : (t = Math.floor(Math.log(o) / Math.log(1024)), a = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], r = 1 * (o / Math.pow(1024, t)).toFixed(2) + " " + a[t]), n._getLayoutTemplate("size").replace("{sizeText}", r)) : ""
        },
        ...
        _setInitThumbAttr: function () {
            ...
            if (0 !== l)
                for (var s = 0; l > s; s++) e = o.config[s], r = n.previewInitId + "-init_" + s, t = i.ifSet("caption", e, i.ifSet("filename", e)), a = i.ifSet("size", e), n._setThumbAttr(r, t, a)
        },
        ...
        _readFiles: function (t) {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var y, x, T, S, F, P, I, k, $, A = g + e,
                    z = u + "-" + A,
                    D = t[e],
                    U = D.name ? r.slug(D.name) : "",
                    j = (D.size || 0) / 1e3,
                    L = "",
                    R = i.objUrl.createObjectURL(D),
                    M = 0,
                    O = "";
                if (h > 0)
                    for (S = 0; h > S; S++) k = v[S], $ = r.msgFileTypes[k] || k, O += 0 === S ? $ : ", " + $;
                if (U === !1) return void a(e + 1);
                if (0 === U.length) return F = r.msgInvalidFileName.replace("{name}", i.htmlEncode(D.name)), void(r.isError = E(F, D, z, e));
                if (i.isEmpty(w) || (L = new RegExp("\\.(" + w.join("|") + ")$", "i")), T = j.toFixed(2), r.maxFileSize > 0 && j > r.maxFileSize) return F = r.msgSizeTooLarge.replace("{name}", U).replace("{size}", T).replace("{maxSize}", r.maxFileSize), void(r.isError = E(F, D, z, e));
                if (null !== r.minFileSize && j <= i.getNum(r.minFileSize)) return F = r.msgSizeTooSmall.replace("{name}", U).replace("{size}", T).replace("{minSize}", r.minFileSize), void(r.isError = E(F, D, z, e));
                if (!i.isEmpty(v) && i.isArray(v)) {
                    for (S = 0; S < v.length; S += 1) P = v[S], M += m[P] ? 1 : 0;
                    if (0 === M) return F = r.msgInvalidFileType.replace("{name}", U).replace("{types}", O), void(r.isError = E(F, D, z, e))
                }
                return 0 !== M || i.isEmpty(w) || !i.isArray(w) || i.isEmpty(L) || (I = i.compare(U, L), M += i.isEmpty(I) ? 0 : I.length, 0 !== M) ? r.showPreview ? !C && j > b ? (r.addToStack(D), s.addClass("file-thumb-loading"), r._previewDefault(D, z), r._initFileActions(), r._updateFileDetails(f), void a(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                    r._errorHandler(e, U)
                }, l.onload = function (i) {
                    r._previewFile(e, D, i, z, R), r._initFileActions()
                    ...
                    if (i.lengthComputable) {
                        var t = i.loaded / i.total * 100,
                            a = Math.ceil(t);
                        F = p.replace("{index}", e + 1).replace("{files}", f).replace("{percent}", a).replace("{name}", U), setTimeout(function () {
                            d.html(F)
                        }, 100)
                    }
        ...
        _setProgress: function (e, t, a) {
            ...
            if (t = t || r.$progress, !i.isEmpty(o)) {
                if (l && n > l && 100 >= e) {
                    var s = o.replace("{percent}", l).replace("{percent}", l).replace("{percent}%", r.msgUploadThreshold);
                    t.html(s)
                } else t.html(o.replace(/\{percent}/g, n));
                a && t.find('[role="progressbar"]').html(a)
            }
        },
        ...
        _validateImage: function (e, t, a) {
            var r, n, o, l = this,
                s = l.$preview,
                d = s.find("#" + e),
                c = d.attr("data-fileindex"),
                p = d.find("img");
            t = t || "Untitled", p.length && i.handler(p, "load", function () {
                n = d.width(), o = s.width(), n > o && (p.css("width", "100%"), d.css("width", "97%")), r = {
                    ind: c,
                    id: e
                }, l._checkDimensions(c, "Small", p, d, t, "Width", r), l._checkDimensions(c, "Small", p, d, t, "Height", r), l.resizeImage || (l._checkDimensions(c, "Large", p, d, t, "Width", r), l._checkDimensions(c, "Large", p, d, t, "Height", r)), l._raise("fileimageloaded", [e]), l.loadedImages.push({
                    ind: c,
                    img: p,
                    thumb: d,
                    pid: e,
        ...
        _validateAllImages: function () {
            ...
            if (a === i.totalImagesCount && (i._raise("fileimagesloaded"), i.resizeImage))
                for (e = 0; e < i.loadedImages.length; e++) i._getResizedImage(i.loadedImages[e], t, a)
        },
        _getResizedImage: function (e, i, t) {
            var a, r, n, o, l, s = this,
                ...
                b = e.ind,
                C = e.thumb;
            if (n = s.isUploadable ? s._showUploadError : s._showError, o = function (e, i, t) {
                    n(e, i, t), s._setPreviewError(C, b)
                }, (!s.filestack[b] || !g || f >= c && m >= p) && (g && s.filestack[b] && s._raise("fileimageresized", [_, b]), i.val++, i.val === t && s._raise("fileimagesresized"), !g)) return void o(s.msgImageResizeError, {
                id: _,
                index: b
            }, "fileimageresizeerror");
            w = w || s.resizeDefaultImageType, a = c > f, r = p > m, u = "width" === s.resizePreference ? a ? f / c : r ? m / p : 1 : r ? m / p : a ? f / c : 1, s._resetCanvas(), c *= u, p *= u, v.width = c, v.height = p;
            try {
                h.drawImage(d, 0, 0, c, p), v.toBlob(function (e) {
                    s.filestack[b] = e, s._raise("fileimageresized", [_, b]), i.val++, i.val === t && s._raise("fileimagesresized", [void 0, void 0]), e instanceof Blob || o(s.msgImageResizeError, {
                        id: _,
                        index: b
                    }, "fileimageresizeerror")
                }, w, s.resizeQuality)
            } catch (E) {
                i.val++, i.val === t && s._raise("fileimagesresized", [void 0, void 0]), l = s.msgImageResizeException.replace("{errors}", E.message), o(l, {
                    id: _,
                    index: b
        ...
        _setCaption: function (t, a) {
            var r, n, o, l, s = this,
                d = s.getFileStack();
            if (s.$caption.length) {
                if (a) r = e("<div>" + s.msgValidationError + "</div>").text(), o = d.length, l = o ? 1 === o && d[0] ? s._getFileNames()[0] : s._getMsgSelected(o) : s._getMsgSelected(s.msgNo), n = '<span class="' + s.msgValidationErrorClass + '">' + s.msgValidationErrorIcon + (i.isEmpty(t) ? l : t) + "</span>";
                else {
        ...
        _change: function (t) {
            ...
            var n, o, l, s, d, c, p = arguments.length > 1,
                u = a.isUploadable,
                f = 0,
                ...
                w = 0,
                _ = function (i, t, r, n) {
                    var o = e.extend(!0, {}, a._getOutData({}, {}, m), {
                            id: r,
                            index: n
                        }),
                        l = {
            ...
            if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), p)
                for (n = []; m[f];) s = m[f], s.type || s.size % 4096 !== 0 ? n.push(s) : w++, f++;
        ...
        _resetFileStack: function () {
            ...
            t._getThumbs().each(function () {
                var o = e(this),
                    ...
                    s = t.filestack[l]; - 1 !== l && (void 0 !== s ? (r[a] = s, n[a] = t._getFileName(s), o.attr({
                    id: t.previewInitId + "-" + a,
                    "data-fileindex": a
                }), a++) : o.attr({
                    id: "uploaded-" + i.uniqId(),
                    "data-fileindex": "-1"
                }))
        ...
        clear: function () {
            var t, a = this;
            return a.$btnUpload.removeAttr("disabled"), a._getThumbs().find("video,audio,img").each(function () {
        ...
        reset: function () {
            var e = this;
            return e._resetPreview(), e.$container.find(".fileinput-filename").text(""), e._raise("filereset"), i.addCss(e.$container, "file-input-new"), (e.$preview.find(i.FRAMES).length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"), e._setFileDropZoneTitle(), e.clearStack(), e.formdata = {}, e.$element
        },
        disable: function () {
            var e = this;
        ...
        upload: function () {
            var t, a, r, n = this,
                ...
                l = {},
                s = !e.isEmptyObject(n._getExtraData());
            if (n.isUploadable && !n.isDisabled) {
                if (n.minFileCount > 0 && n._getFileCount(o) < n.minFileCount) return void n._noFilesError(l);
                if (0 === o && !s) return n._resetUpload(), void n._showUploadError(n.msgUploadEmpty);
                if (n._resetUpload(), n.$progress.removeClass("hide"), n.uploadCount = 0, n.uploadStatus = {}, n.uploadLog = [], n.lock(), n._setProgress(2), 0 === o && s) return void n._uploadExtraOnly();
                ...
                for (n.$preview.find(".file-preview-initial").removeClass(i.SORT_CSS), n._initSortable(), n.cacheInitialPreview = {
                        content: n.initialPreview,
                        config: n.initialPreviewConfig,
                        tags: n.initialPreviewThumbTags
                    }, t = 0; r > t; t++) void 0 !== n.filestack[t] && n._uploadSingle(t, n.filestack, !0)
            }
        },
        destroy: function () {
            var e = this,
                t = e.$container;
            return t.find(".file-drop-zone").off(), e.$element.insertBefore(t).off(i.NAMESPACE).removeData(), t.off().remove(), e.$element
        },
        refresh: function (i) {
            var t = this,
                a = t.$element;
        ...
        removeLabel: "حذف",
        removeTitle: "حذف الملفات المحددة",
        cancelLabel: "رجوع",
        cancelTitle: "ايقاف التحميل",
        uploadLabel: "رفع",
        uploadTitle: "رفع الملفات المحددة",
        msgNo: "لا",
        msgNoFilesSelected: "لا توجد ملفات محددة",
        msgCancelled: "تم ايقافها",
        msgZoomModalHeading: "وصف العرض",
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) صغير جدا لابد ان يكون اكبر من <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) لقد تخطي الحد الاقصي المسموح به عن <b>{maxSize} KB</b>.',
        msgFilesTooLess: "You must select at least <b>{n}</b> {files} to upload.",
        msgFilesTooMany: "عدد الملفات المححدة للرفع <b>({n})</b> لقد تخطت الحد الاقصي <b>{m}</b>.",
        msgFileNotFound: 'الملف "{name}" غير موجود!',
        msgFileSecured: 'من اجل الحماية والامان لم تتم قراءة الملف "{name}".',
        msgFileNotReadable: 'الملف "{name}" غير واضح للقراءة.',
        msgFilePreviewAborted: 'تم ايقاف عرض الصورة بسبب "{name}".',
        ...
        msgUploadAborted: "فشل رفع الملف",
        ...
        ajaxOperations: {
            deleteThumb: "تم حذف الملف",
            uploadThumb: "single file upload",
            uploadBatch: "batch file upload",
            uploadExtra: "form data upload"
        },
        dropZoneTitle: "اسحب الملفات وضعها هنا &hellip;",
        dropZoneClickTitle: "<br>(or click to select {files})",
        previewZoomButtonTitles: {
            prev: "رؤية الملف السابق",
            next: "رؤية الملف التالي",
