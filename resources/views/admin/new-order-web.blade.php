                        ...
                        <div class="p-md clearfix widget widget-def widget-panels widget-users widget-financial widget-request">
                            ...
                            <div class="widget-body">
                                <div class="contact-form col-xs-12">
                                    <form action="{{url('requestwebstore')}} " method="post">
                                    {{csrf_field()}}
                                     <input type="hidden" name="category_id" class="form-control" value="57">
                                     ...
                                     @endif
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <select name="site_type" class="form-control">
                                                <option value="63">موقع إخباري</option>
                                                <option value="64">موقع لشركة</option>
                                                <option value="65">متجر إلكتروني</option>
                                                <option value="66">موقع عقاري</option>
                                                <option value="67">موقع إعلانات</option>
                                                <option value="68">موقع تجاري</option>
                                                <option value="69">غير هذا</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-xs-12">
                                            <label>استعمال اطار العمل</label>
                                            <select name="framework" class="form-control">
                                                <option value="0">لا أعلم</option>
