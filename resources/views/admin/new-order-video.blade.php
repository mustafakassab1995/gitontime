                        ...
                        <div class="p-md clearfix widget widget-def widget-panels widget-users widget-financial widget-request">
                            ...
                            <div class="widget-body">
                                <div class="contact-form col-xs-12">
                                    <form action="{{url('requestvideostore')}} " method="post">
                                    {{csrf_field()}}
                                     <input type="hidden" name="category_id" class="form-control" value="55">
                                     ...
                                     @endif
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label for="full_name">مدة الفيديو</label>
                                            <input type="text" name="time" class="form-control" id="full_name" value="30">
                                        </div>
                                        <div class="form-group col-xs-12">
                                            <label for="full_name">مقاس الفيديو</label>
                                            <input type="text" name="size" class="form-control" id="full_name" value="600 x 400">
                                        </div>
                                        <div class="form-group col-xs-12">
                                            <label>تعليق صوتي</label>
                                            <select name="voice_comment" class="form-control">
                                               <option value="0">لا</option>
                                                    <option value="1">نعم</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-xs-12">
                                            <label>نماذج صوت</label>
                                            <select name="vioce_model" class="form-control">
                                               <option value="61">النمودج الأول</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-xs-12">
                                            <label>وجود موسيقى</label>
