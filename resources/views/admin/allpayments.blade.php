@if(empty($allpayments))
 <div class="msg-no-panel col-md-12 col-xs-12">
                                ...
                                @else
@foreach($allpayments as $request)
<div class="col-md-4 col-sm-6">
                                        ...
                                        <div class="widget-body p-h-lg">
                                            <div class="media">
                                                <div class="media-left">
                                                    <div class="avatar avatar-lg avatar-circle"><img class="img-responsive" src="{{$request->employee->avatar}}" alt="avatar"></div>
                                                </div>
                            ...
                            {{$allpayments->links('vendor.pagination.allpaymentsp')}}
