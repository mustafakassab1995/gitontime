                        ...
                        <div class="p-md clearfix widget widget-def widget-panels widget-users widget-financial widget-request">
                            ...
                            <div class="widget-body">
                                <div class="contact-form col-xs-12">
                                    <form action="{{url('requestdesignstore')}} " method="post">
                                    {{csrf_field()}}
                                     ...
                                     @endif
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <select name="type" class="form-control">
                                                <option value="0">أغلفة كتب ومجلات</option>
                                                <option value="1">بانرات إعلانية</option>
                                                <option value="2">بطاقات أعمال</option>
                                                <option value="3">شعارات</option>
                                                <option value="4">عروض تقديمية</option>
                                                <option value="5">شيء أخر</option>
                                            </select>
                                        </div>
