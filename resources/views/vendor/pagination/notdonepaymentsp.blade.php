            ...
            @if (is_array($element))
                @foreach ($element as $page => $url)
                    @if ($page == $paginator->currentPage())
                        <li class="paginate_button active notdonepayments_button"><span>{{ $page }}</span></li>
                    @else
                        <li class="paginate_button notdonepayments_button"><a href="{{url('notdonepayments')}}?page={{ $page }}">{{ $page }}</a></li>
                    @endif
                @endforeach
            @endif
        @endforeach
