            ...
            @if (is_array($element))
                @foreach ($element as $page => $url)
                    @if ($page == $paginator->currentPage())
                        <li class="paginate_button active donepayment_button"><span>{{ $page }}</span></li>
                    @else
                        <li class="paginate_button donepayment_button"><a href="{{url('donepayment')}}?page={{ $page }}">{{ $page }}</a></li>
                    @endif
                @endforeach
            @endif
        @endforeach
