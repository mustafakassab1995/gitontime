            ...
            @if (is_array($element))
                @foreach ($element as $page => $url)
                    @if ($page == $paginator->currentPage())
                        <li class="paginate_button active notconfirmed_button"><span>{{ $page }}</span></li>
                    @else
                        <li class="paginate_button notconfirmed_button"><a href="{{url('notconfirmed')}}?page={{ $page }}">{{ $page }}</a></li>
                    @endif
                @endforeach
            @endif
        @endforeach
